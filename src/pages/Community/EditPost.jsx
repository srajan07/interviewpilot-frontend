...
function EditPost() {
  ...
  useEffect(() => {
    async function fetchPost() {
      try {
        ...
        setFormData({
          title: post.title || "",
          workedOn: post.workedOn || "",
          confusedBy: post.confusedBy || "",
  ...
  const handleSubmit = async (event) => {
    ...
    if (
      ...
      setError(
        "Title and main reflection are required."
      );
      return;
    }
    ...
    try {
      ...
      setError(
        error.response?.data?.message ||
        "Failed to update the journey entry."
      );
    } finally {
      setSaving(false);
    }
      ...
      <div className="w-full max-w-2xl mx-auto px-5 sm:px-8 py-10 sm:py-14">
        ...
        <section className="pb-7 border-b border-[#E2E3DE]">
          ...
          <h1 className="text-3xl sm:text-4xl font-semibold tracking-tight">
            Edit your learning moment.
          </h1>

          <p className="mt-3 text-sm sm:text-[15px] text-[#70757D] leading-relaxed">
            Update what you worked on, what confused you,
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <label className="text-sm font-medium text-[#20242B]">
              Title
              <span className="text-[#A55D5D] ml-1">
                *
              </span>
            </label>
          ...
          <section className="border border-[#E2E3DE] bg-[#FCFCF9] rounded-2xl p-5 sm:p-6">
            ...
            <div className="mb-5">
              ...
              <p className="text-sm text-[#70757D] mt-1.5 leading-6">
                These help turn your post into something another
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="e.g. I thought HashMap was always better"
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-[#9A9EA4]">
              Add a screenshot, diagram, or image that helped
